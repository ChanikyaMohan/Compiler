...
public class TypeCheckVisitorTest {
    ...
    public void testSleepStatement() throws Exception {
        ...
        assertEquals(Type.TypeName.INTEGER, expression.type);
    }
...
//        thrown.expect(TypeCheckVisitor.TypeCheckException.class);
    ...
    public void testFilterOpChain() throws Exception {
        ...
        assertEquals(Type.TypeName.IMAGE, e0.type);
        assertEquals(Type.TypeName.IMAGE, e1.type);
    }
    ...
    public void testBinaryChain2() throws Exception {
        ...
        assertEquals(Type.TypeName.FRAME, binaryChain.type);
    }
    ...
    public void testBinaryChain5() throws Exception {
        ...
        for (String input : inputList) {
            ...
            assertEquals(Type.TypeName.INTEGER, binaryChain.type);
        }
    }
    ...
    public void testWhileStatement0() throws Exception {
        ...
        assertEquals(Type.TypeName.BOOLEAN, expression.type);
    }
    ...
    public void testIdentExpression() throws Exception {
        ...
        TypeCheckVisitor typeCheckVisitor = new TypeCheckVisitor();
        program.visit(typeCheckVisitor, null);
        assertEquals(Type.TypeName.INTEGER, identExpression.type);
        assertEquals(decs.get(0), identExpression.d);
    }
    ...
    public void testIdentLValue() throws Exception {
        ...
        TypeCheckVisitor typeCheckVisitor = new TypeCheckVisitor();
        program.visit(typeCheckVisitor, null);
        assertEquals(decs.get(1), identLValue.dec);
    }
    ...
    public void testIntLitExpression() throws Exception {
        ...
        assertEquals(Type.TypeName.INTEGER, intLitExpression.type);
    }
    ...
    public void testBooleanLitExpression0() throws Exception {
        ...
        assertEquals(Type.TypeName.BOOLEAN, booleanLitExpression.type);
    }
    ...
    public void testConstantExpression0() throws Exception {
        ...
        assertEquals(Type.TypeName.INTEGER, constantExpression.type);
    }
    ...
    public void testBinaryExpr0() throws Exception {
        ...
        assertEquals(Type.TypeName.INTEGER, binaryExpression.type);
    }
    ...
    public void testBinaryExpr1() throws Exception {
        ...
        assertEquals(Type.TypeName.IMAGE, binaryExpression.type);
    }
    ...
    public void testBinaryExpr5() throws Exception {
        ...
        for (String input : inputList) {
            ...
            assertEquals(Type.TypeName.BOOLEAN, binaryExpression.type);
        }
    }
    ...
    public void testImageOpChain1() throws Exception {
        ...
        assertEquals(Type.TypeName.IMAGE, imageOpChain0.type);
        assertEquals(Type.TypeName.INTEGER, imageOpChain1.type);

//        assertEquals(Scanner.Kind.KW_SCALE, imageOpChain0.type);
//        assertEquals(Scanner.Kind.OP_HEIGHT, imageOpChain1.type);
    }
